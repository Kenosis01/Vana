...
export class VanaErrorBoundary extends React.Component<Props, State> {
		...
		return (
			<div>
				...
				<p className="mb-4">
					...
					reach out to us on{" "}
					<a href="https://github.com/Vana-Org/vana/issues" target="_blank" rel="noreferrer">
						GitHub
					</a>{" "}
					or{" "}
					<a href="https://discord.vana.ai" target="_blank" rel="noreferrer">
						Discord
					</a>
					.
				</p>
